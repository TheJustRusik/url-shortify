...
const (
	Analytics_LogVisit_FullMethodName = "/analytics.Analytics/LogVisit"
)
...
type AnalyticsClient interface {
	LogVisit(ctx context.Context, in *VisitRequest, opts ...grpc.CallOption) (*VisitResponse, error)
}
...
func (c *analyticsClient) LogVisit(ctx context.Context, in *VisitRequest, opts ...grpc.CallOption) (*VisitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VisitResponse)
	err := c.cc.Invoke(ctx, Analytics_LogVisit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AnalyticsServer interface {
	LogVisit(context.Context, *VisitRequest) (*VisitResponse, error)
...
func (UnimplementedAnalyticsServer) LogVisit(context.Context, *VisitRequest) (*VisitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LogVisit not implemented")
}
...
func _Analytics_LogVisit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VisitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServer).LogVisit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Analytics_LogVisit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServer).LogVisit(ctx, req.(*VisitRequest))
	}
...
var Analytics_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "LogVisit",
			Handler:    _Analytics_LogVisit_Handler,
		},
	},
